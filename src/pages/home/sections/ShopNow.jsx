...
function ShopNow() {
    return (
        <div className='my-10 relative'>
            ...
            <div className=' absolute left-0 md:left-1/2 top-0 bottom-0 right-0 flex items-center justify-end rounded-3xl text-white'>
                <div className='md:pe-20 grid gap-3 px-5'>
                    ...
                    <p className=' text-[#b5b5b5] text-xl md:text-2xl'>Free on all your order, Free Shipping and 30 days mony back guarantee</p>
                    <div>
                        <Link to={'/shop'}>
                            <button
